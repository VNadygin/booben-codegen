 ...
 * @return {StringLiteral|NumericLiteral|BooleanLiteral|NullLiteral|ArrayExpression|ObjectExpression}
 */
const constBoobenValue = boobenValue => generateLiteral(boobenValue.sourceData.value);
...
const functionBoobenValue = (boobenValue, path, file) => {
  ...
  return t.callExpression(t.identifier(boobenValue.sourceData.function), argASTs);
};
